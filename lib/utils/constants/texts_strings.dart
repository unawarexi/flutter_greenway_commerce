class TTexts {
  ...
  static const String subOnboardingTitle1 =
      'Browse our wide range of eco-friendly products, designed for a sustainable lifestyle.';
  static const String subOnboardingTitle2 =
      'Pay securely and conveniently with multiple payment options tailored for your needs.';
  static const String subOnboardingTitle3 =
      'We deliver wherever you are, so you can enjoy your shopping without limits.';

  // Home
  static const String homeAppBarTitle = 'Greenway Commerce';
  static const String homeAppBarSubtitle = 'Sustainable Shopping, dear Andrew!';
  ...
  static const String rememberMeTitle = "Remeber Me";
  ...
  static const String dividerTitle = "Or sign in wiih";
  static const String subSignUpTitle =
      "Join the fun – the deals won’t hunt themselves!";
  static const String forgotPasswordSubtitle =
      "Don't worry, we've got you. Enter your email to reset it.";
  ...
  static const String emailConfirmationSubtitle =
      "A confirmation link has been sent to your email. Please follow the link to verify your account.";
  ...
  static const String emailSupportMessage =
      "For any account-related queries, reach out to us at support@greenwaycommerce.com";

  // Success Messages
  static const String accountCreatedSuccess =
      "Account successfully created! Welcome to Greenway Commerce!";
  static const String emailVerifiedSuccess =
      "Email successfully verified! You’re all set to explore!";
  static const String passwordChangedSuccess =
      "Password successfully changed! Your account is now more secure.";
